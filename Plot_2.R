...
plot(Sub_Elc_Pwr_Cons$Time,as.numeric(as.character(Sub_Elc_Pwr_Cons$Global_active_power)),type="l",xlab="",ylab="Global Active Power (kilowatts)") 


title(main="Global Active Power Vs Time")


dev.copy(png, filename="Plot_2.png")
dev.off()